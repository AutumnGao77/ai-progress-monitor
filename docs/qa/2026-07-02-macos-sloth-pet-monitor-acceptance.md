...
| 真实运行 | macOS 开发态 App 已多轮真实测试；v0.2.1 GitHub 下载后人工验收通过 |
| 完整目标状态 | 主路径已验收，[v0.2.1](https://github.com/AutumnGao77/ai-progress-monitor/releases/tag/v0.2.1) 已作为 GitHub Release 发布 |
