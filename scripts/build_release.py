    ...
    (RELEASE_DIR / "README.txt").write_text(
        "\n".join(
            [
                ...
                "",
                "Direct Claude/Codex CLI detection:",
                "  If you run claude or codex directly, the monitor shows a process-only bubble while the CLI is still interactive.",
                ...
                "  Codex CLI is currently classified conservatively by process activity.",
                ...
                "  Run wrapper commands from the project folder you want Claude/Codex to work in.",
